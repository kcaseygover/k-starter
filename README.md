Sample ui components with different states

To run [Storybook](https://storybook.js.org/), a UI development environment for UI components:
```
git clone git@github.com:kcaseygover/k-starter.git
npm install
npm run storybook
open localhost:9009
```
